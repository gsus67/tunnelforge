...
func main() {
	...
	mux.HandleFunc("/api/herramientas/mikrotik/script", proteger(manejarMikrotikScript))
	mux.HandleFunc("/api/herramientas/mikrotik/speedtest", proteger(manejarMikrotikSpeedtest))
